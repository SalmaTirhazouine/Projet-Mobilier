...
@Component({
  selector: 'app-cuilistadmin',
  templateUrl: './cuilistadmin.component.html',
  styleUrls: ['./cuilistadmin.component.css']
})
export class CuilistadminComponent implements OnInit  {
  ...
  produit!: Produit[];
  selectedCategorie: string = 'Cuisine Marocaine'; 
