...
@Component({
  selector: 'app-bardlistadmin',
  templateUrl: './bardlistadmin.component.html',
  styleUrls: ['./bardlistadmin.component.css']
})
export class BardlistadminComponent  implements OnInit  {
  ...
  produit!: Produit[];
  selectedCategorie: string = 'Bardages'; 
