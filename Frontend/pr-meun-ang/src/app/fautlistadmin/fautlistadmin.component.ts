...
@Component({
  selector: 'app-fautlistadmin',
  templateUrl: './fautlistadmin.component.html',
  styleUrls: ['./fautlistadmin.component.css']
})
export class FautlistadminComponent implements OnInit  {
  ...
  produit!: Produit[];
  selectedCategorie: string = 'Fauteuils'; 
