...
@Component({
  selector: 'app-dreslistadmin',
  templateUrl: './dreslistadmin.component.html',
  styleUrls: ['./dreslistadmin.component.css']
})
export class DreslistadminComponent  implements OnInit  {
  ...
  produit!: Produit[];
  selectedCategorie: string = 'Dressings-Placards'; 
