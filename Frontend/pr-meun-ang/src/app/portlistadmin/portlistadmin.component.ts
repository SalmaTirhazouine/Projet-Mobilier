...
@Component({
  selector: 'app-portlistadmin',
  templateUrl: './portlistadmin.component.html',
  styleUrls: ['./portlistadmin.component.css']
})
export class PortlistadminComponent  implements OnInit  {
  ...
  produit!: Produit[];
  selectedCategorie: string = 'Portes'; 
