...
@Component({
  selector: 'app-dreslist',
  templateUrl: './dreslist.component.html',
  styleUrls: ['./dreslist.component.css']
})
export class DreslistComponent  implements OnInit  {
...
ngOnInit(): void {
  ...
  const categorieParDefaut = 'Dressings-Placards';
