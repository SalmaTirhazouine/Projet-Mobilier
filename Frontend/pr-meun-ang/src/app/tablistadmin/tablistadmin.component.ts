...
@Component({
  selector: 'app-tablistadmin',
  templateUrl: './tablistadmin.component.html',
  styleUrls: ['./tablistadmin.component.css']
})
export class TablistadminComponent implements OnInit  {
  ...
  produit!: Produit[];
  selectedCategorie: string = 'Tables'; 
